...
static esp_err_t stream_handler(httpd_req_t *req) {
  ...
  // Set headers for better streaming performance
  httpd_resp_set_hdr(req, "Access-Control-Allow-Origin", "*");
  ...
  while (true) {
    ...
    // Limit logging frequency to reduce overhead
    ...
    // Small delay to maintain consistent frame rate
    if (frame_time < 33) {  // Target 30 FPS (33ms per frame)
